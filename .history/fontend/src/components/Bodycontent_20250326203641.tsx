...
const Bodycontent: React.FC = () => {
  return (
    <main className="flex-1 p-4">
      <h1 className="text-2xl font-bold mb-4 p-4">Những bài hát thịnh hành</h1>
      ...
      <h1 className="text-2xl font-bold mb-4 pt-5">Radio phổ biến</h1>
      <div className="flex gap-4 overflow-x-auto md:grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 md:overflow-x-hidden">
        {Array.from({ length: 5 }).map((_, index) => (
          <div
            key={index}
      ...
      <h1 className="text-2xl font-bold mb-4">Bảng xếp hạng nổi bật</h1>
      <div className="flex gap-4 overflow-x-auto md:grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 md:overflow-x-hidden">
        {Array.from({ length: 5 }).map((_, index) => (
          <div
            key={index}
