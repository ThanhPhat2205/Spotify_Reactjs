  ...
  return (
    <div className="flex justify-center items-center h-screen bg-spotify ">
      <div className="bg-[#121212] rounded-lg p-10 lg:w-[40%] w-full h-screen text-white">
        ...
        <button className="w-full py-2 mb-3 bg-black hover:bg-gray-600 rounded-full border-white flex items-center justify-center">
          <img src="/google-icon.svg" alt="Google" className="w-5 h-5 mr-2" />
          Tiếp tục bằng Google
        </button>
        <button className="w-full py-2 mb-3 bg-gray-700 hover:bg-gray-600 rounded-full  flex items-center justify-center">
          <img src="/facebook-icon.svg" alt="Facebook" className="w-5 h-5 mr-2" />
          Tiếp tục bằng Facebook
        </button>
        <button className="w-full py-2 mb-3 bg-gray-700 hover:bg-gray-600 rounded-full border-white flex items-center justify-center">
          <img src="/apple-icon.svg" alt="Apple" className="w-5 h-5 mr-2" />
          Tiếp tục bằng Apple
        </button>
        <button className="w-full py-2 mb-6 bg-gray-700 hover:bg-gray-600 rounded-full border-white flex items-center justify-center">
