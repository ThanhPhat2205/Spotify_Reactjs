    ...
    return(
        ...
        <div className="flex gap-4 overflow-x-auto  md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 md:overflow-x-hidden">
          {Array.from({ length: 6 }).map((_, index) => (
            ...
            >
              <div className="flex items-center justify-center absolute pt-20 opacity-0 translate-y-16 group-hover:translate-y-0  group-hover:opacity-100  transition-all duration-300 ease-in-out">
