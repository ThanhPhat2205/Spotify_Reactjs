    ...
    return(
        <div>
            <aside className="hidden md:block w-full border-r border-gray-700 p-2">
                ...
                >
                    <h3>Tạo danh sách phát đầu tiên của bạn <h3></h3>
                    Rất dễ! chúng tôi sẽ giúp bạn
                    <button className="px-4 py-2 bg-white text-black rounded-full text-sm font-semibold hover:bg-gray-200 hover:scale-110 transition " aria-label="Login">
                        Tạo danh sách phát
                    </button>
                </div>
                <div
