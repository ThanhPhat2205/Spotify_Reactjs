    ...
    <header className=" fixed top-0 w-full z-10 flex items-center bg-black justify-between p-4 border-b border-gray-700">
      ...
      <svg
        ...
        <svg
          ...
          className="h-6 w-6 text-gray-400 hover:text-white transition duration-300"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
          <path
            ...
            strokeWidth={2}
            d="M5 8h14M5 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 16h14m-14-15a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm14 10h-2.586a1 1 0 0 1-.707-.293l-2.414-2.414a1 1 0 0 1-.293-.707V4m-5 6h2a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1h-2"
          />
        </svg>
      </div>
