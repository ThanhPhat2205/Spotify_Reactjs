...
const Bodyplay: React.FC=()=>{
    return(
        <div className="">
            <aside className="hidden md:block w-full border-r border-gray-700 p-2 fixed z-40 isolate">
                <h2 className="text-xl text-white font-bold mb-4">Thư viện</h2>
                <div
                    className="bg-[#2A2A2A] text-white w-[30%] rounded-md px-3 py-2 text-left hover:bg-[#333333] transition"
                    aria-label="Create Playlist"
                >
                    <h3>Tạo danh sách phát đầu tiên của bạn </h3>
                    <h4>Rất dễ bạn ơi! tạo ngay đi người đẹp</h4>
                ...
                <div
                    className="bg-[#2A2A2A] w-[30%] rounded-md px-3 py-2 text-left mt-2 hover:bg-[#333333] transition"
                    aria-label="Liked Songs"
                >
                    Bài hát đã thích
                </div>
                <hr className="my-4 w-[30%] border-gray-700" />
