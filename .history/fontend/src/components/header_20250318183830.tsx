...
return(
    <header className="flex items-center bg-black justify-between p-4 border-b border-gray-700">
      ...
      <nav className="hidden md:flex items-center space-x-6 ml-4">
        ...
        <a href="#" className="text-sm hover:text-white transition text-gray-400" aria-label="Support">
          Hỗ trợ
        </a>
        <a href="#" className="text-sm hover:text-white transition text-gray-400" aria-label="Download">
          Tải xuống
        </a>
        <a href="#" className="text-sm hover:text-white,text-lg transition text-gray-400" aria-label="Install App">
          Cài đặt Ứng dụng
        </a>
      </nav>
