...
const Bodycontent: React.FC=()=>{
    return(
        ...
        <div className="flex gap-4 overflow-x-auto sm:grid sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 sm:overflow-x-hidden">
        ...
        <div className="flex gap-4 lg:overflow-x-auto sm:grid  sm:grid-cols-3  md:grid-cols-4 lg:grid-cols-6 md:overflow-x-hidden sm:overflow-x-hidden">
