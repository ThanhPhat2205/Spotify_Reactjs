...
return(
    <header className=" fixed top-0 w-full z-10 flex items-center bg-black justify-between p-4 border-b border-gray-700">
      ...
      <div className="md:hidden">
        ...
        <Link className="hidden sd:block" to=''><svg className="w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20" aria-label="Search Icon"><path fillRule="evenodd" d="M12.9 14.32a8 8 0 111.414-1.414l4.387 4.386a1 1 0 01-1.414 1.414l-4.386-4.387zM14 8a6 6 0 11-12 0 6 6 0 0112 0z" clipRule="evenodd"/></svg>
        </Link>
