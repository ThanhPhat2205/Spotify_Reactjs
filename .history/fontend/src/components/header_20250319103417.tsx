...
return(
    <header className=" fixed top-0 w-full z-10 flex items-center bg-black justify-between p-4 border-b border-gray-700">
      ...
      <div className="bg-[#2A2A2A] flex items-center space-x-2 flex-1 max-w-[300px] md:max-w-[400px] rounded-full p-1 focus:outline focus:outline-white focus:outline-1 focus:outline-offset-2">
      <svg
          className="w-5 h-5 text-gray-400"
          fill="currentColor"
          viewBox="0 0 20 20"
