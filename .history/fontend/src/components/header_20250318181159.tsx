...
return(
    <header className="flex items-center justify-between p-4 border-b border-gray-700">
      <div className="bg-[#2A2A2A] flex items-center space-x-2 flex-1 max-w-[300px] md:max-w-[400px]">
        <svg
        ...
        <input
          ...
          className="bg-[#2A2A2A] text-sm text- p-2 w-full rounded-md outline-none placeholder:text-gray-400"
