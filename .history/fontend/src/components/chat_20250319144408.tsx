    ...
    <div className="fixed bottom-20 left-4 z-50">
      ...
      {!isOpen && (
        <button
          ...
          className="bg-white text-black p-4 rounded-full shadow-lg hover:bg-blue-600"
        >
          Chat
        </button>
      )}
          ...
          <div className="p-3 border-t">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-bg-[#2A2A2A]"
