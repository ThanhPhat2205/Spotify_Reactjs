...
const Bodycontent: React.FC=()=>{
  ...
  <div class="w-16 h-16 bg-green-500 rounded-full flex items-center justify-center cursor-pointer hover:bg-green-600 transition-colors">
    <!-- Hình tam giác (play) -->
    <div class="w-0 h-0 border-l-[12px] border-l-black border-y-[8px] border-y-transparent"></div>
  </div>
</div>
        </div>
